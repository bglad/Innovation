...
if($flow_seo_module == 1){ }else{
	...
	function flow_seo_admin_scripts(){
		wp_register_script('flow_seo', get_bloginfo('template_directory') . '/admin/meta_boxes/seo/seo.js', array('jquery'), '1.0');
		//wp_register_style('flow_seo_css', get_bloginfo('template_directory') . '/admin/meta_boxes/seo/seo.css');
