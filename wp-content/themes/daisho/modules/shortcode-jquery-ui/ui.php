...
function toggle_shortcode($atts, $content = null){
	...
	return "<div class=\"".$toggle_type."\"><div class=\"toggle\"><div class=\"toggle_title".$toggle_open_class."\">".$atts['title']."</div><div class=\"toggle_content\" style=\"".$toggle_open."\">".do_shortcode($content)."</div></div></div>";
}
